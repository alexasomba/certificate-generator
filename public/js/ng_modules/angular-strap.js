...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.affix', [ 'mgcrea.ngStrap.helpers.dimensions', 'mgcrea.ngStrap.helpers.debounce' ]).provider('$affix', function() {
    ...
    this.$get = [ '$window', 'debounce', 'dimensions' , '$rootScope', function($window, debounce, dimensions , $rootScope) {
      ...
      function AffixFactory(element, config) {
        ...
        $affix.checkPosition = function() {
          ...
          if (affix === 'top') {
            unpin = null;
            element.css('box-shadow', '0 5px 5px 0px rgba(0, 0, 0, 0)');
            $rootScope.$broadcast('my:unfixed' , {});
            if (setWidth) {
              element.css('width', '');
            }
            ...
            if (options.inlineStyles) {
              ...
              element.css('box-shadow', '0 5px 5px 0px rgba(0, 0, 0, 0.4)');
			        $rootScope.$broadcast('my:fixed' , {});
            }
          }
        };
